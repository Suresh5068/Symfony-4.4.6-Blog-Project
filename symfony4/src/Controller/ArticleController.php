...
class ArticleController extends AbstractController{
    ...
    public function delete(Request $request , $id){
     ...
     public function upload(Request $request){
       $article = new Article();
        ...
        return $this->render('/articles/upload.html.twig',array('form'=>$form->createView()));
    }
    ...
    //     $article->setBody('This the body of atricles two');
    //     $entityManager->persist($article);
    //     $entityManager->flush();

    //     return new Response('saved an article with the'.$article->getId());
    // }
